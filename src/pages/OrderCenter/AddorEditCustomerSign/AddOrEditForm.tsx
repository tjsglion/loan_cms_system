...
const AddOrEditForm: React.FC<AddOrEditFormProps> = (props) => {
  ...
  return (
    ...
    >
      <Row gutter={24}>
        <Col {...COLSPAN}>
          <FormItem label="委托甲方" name="entrustFirstParty" {...RULES}>
            <Input {...TEXTINFO}/>
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
        ...
        <Col {...COLSPAN}>
          <FormItem label="进件类型" name="jinjianType" {...RULES}>
            <Radio.Group>
        ...
        <Col {...COLSPAN}>
          <FormItem label="贷款金额" name="loanMoney" {...RULES}>
            <InputNumber style={{ width: '100%' }} min={0} {...TEXTINFO}/>
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
          <FormItem label="已收定金" name="alreadyDepositMoney" {...RULES}>
          <InputNumber style={{ width: '100%' }} min={0} {...TEXTINFO}/>
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
          <FormItem label="收款方式" name="chequeType" {...RULES}>
            <Radio.Group>
        ...
        <Col {...COLSPAN}>
          <FormItem label="贷款收费" name="loanFee" {...RULES}>
          <InputNumber style={{ width: '100%' }} min={0} {...TEXTINFO}/>
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
          <FormItem label="收费说明" name="feeRemark" {...RULES}>
            <Input.TextArea {...TEXTINFO}  autoSize={{minRows: 1, maxRows: 2}}/>
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
          <FormItem label="签单时间" name="signUpTime" {...RULES}>
            <DatePicker style={{ width: '100%' }} locale={locale} format={DATEFORMAT}/>
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
          <FormItem label="评估方式" name="assessType" {...RULES}>
            <Radio.Group>
        ...
        {/* 评估收费 */}
        {/* <Col {...COLSPAN}>
          <FormItem label="评估收费" name="capitalId" {...RULES}>
            <Select {...OPTIONSPLACEHOLDER}>
              <Option key="0" value={0}>aaa</Option>
              <Option key="1" value={1}>bbb</Option>
            </Select>
        ...
        <Col {...COLSPAN}>
          <FormItem label="做单部门" name="followDepartId" {...RULES}>
            <Select {...OPTIONSPLACEHOLDER}>
              <Option key="0" value={0}>aaa</Option>
              <Option key="1" value={1}>bbb</Option>
            </Select>
        ...
        <Col {...COLSPAN}>
          <FormItem label="做单人员" name="followUserId" {...RULES}>
            <Input {...TEXTINFO} />
          </FormItem>
        </Col>
        <Col {...COLSPAN}>
          <FormItem label="签单须知" name="signUpNeedKnows" {...RULES}>
            <Input.TextArea {...TEXTINFO}  autoSize={{minRows: 1, maxRows: 2}}/>
          </FormItem>
        </Col>

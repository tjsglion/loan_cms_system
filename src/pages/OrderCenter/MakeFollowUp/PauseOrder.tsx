...
interface PauseOrderIProps {}

const PauseOrder: React.FC<PauseOrderIProps> = () => {
          ...
          <>
            ...
            <Authorized authority={['admin']}>
              ...
              {/* {
               ...
               <a onClick={() => history.push(`/order/pause/editSign?customerId=${customerId}&workNo=${workNo}&type=edit&parentPath=${path}`)}>
                  编辑签单
                </a>
            </Authorized>
          </>

...
interface ExpiredOrderIProps {}

const ExpiredOrder: React.FC<ExpiredOrderIProps> = () => {
        ...
        return (
          <>
            ...
            <Authorized authority={['admin']}>
              ...
              <a onClick={() => history.push(`/order/expired/editSign?customerId=${customerId}&workNo=${workNo}&type=edit&parentPath=${path}`)}>
                编辑签单
              </a>

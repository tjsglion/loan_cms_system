...
interface CompletedOrderIProps {}

const { RangePicker } = DatePicker;
const { Option } = Select;

const CompletedOrder: React.FC<CompletedOrderIProps> = () => {
        ...
        return (
          <>
            <Authorized authority={['admin']}>
              <a onClick={() => history.push(`/order/completed/editSign?customerId=${customerId}&workNo=${workNo}&type=edit&parentPath=${path}`)}>
                编辑签单
              </a>
            </Authorized>
          </>
